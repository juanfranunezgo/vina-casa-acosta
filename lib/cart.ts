...
// La compra mínima vive en lib/compraMinima.ts para que el servidor también
// pueda leerla; se reexporta para que el carrito la siga importando de acá.
export { MIN_BOTTLES } from "@/lib/compraMinima";
